...
| Storage Accounts | Full | None | `azurerm_storage_account`, `azurerm_storage_container` | Full (management plane; SKU/kind at top level; fake primary endpoints; name uniqueness check; blob containers as child resources with cascade delete) | [storage_account_test.go](../internal/arm/storage_account_test.go), [storage_container_test.go](../internal/arm/storage_container_test.go), [arm_test.go](../test/integration/arm_test.go) |
| Key Vault | None | None | `azurerm_key_vault`, `azurerm_key_vault_secret` | Planned (v0.2) | -- |
