...
func (a *Router) Routes(r chi.Router) {
	...
	// Front Door endpoints (Microsoft.Cdn/profiles/afdEndpoints)
	r.Put("/{subscriptionID}/resourcegroups/{resourceGroupName}/providers/microsoft.cdn/profiles/{profileName}/afdendpoints/{endpointName}", a.putAFDEndpoint)
	...
	r.Put("/{subscriptionID}/resourcegroups/{resourceGroupName}/providers/microsoft.cdn/profiles/{profileName}/afdendpoints/{endpointName}/routes/{routeName}", a.putAFDRoute)
	...
	r.Put("/{subscriptionID}/resourcegroups/{resourceGroupName}/providers/microsoft.cdn/profiles/{profileName}/origingroups/{originGroupName}", a.putAFDOriginGroup)
	...
	r.Put("/{subscriptionID}/resourcegroups/{resourceGroupName}/providers/microsoft.cdn/profiles/{profileName}/origingroups/{originGroupName}/origins/{originName}", a.putAFDOrigin)
